...
<div class= "container mx-auto px-4 py-8">
    ...
    <h3 class="text-lg font-normal mb-2">Data Event</h3>
        <div class="space-y-4">
    {!! Form::open(['url' => 'events/create', 'method' => 'post'])!!}
        <div class="form-group @if($errors->first('name')) has-error @endif">
            {{ Form::label('name', 'Event', ['class' => 'control-label block font-medium text-gray-700 ml-7']) }}
        ...
        <button type="submit" class="btn btn-danger bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 ml-6 rounded">Tambah</button>
